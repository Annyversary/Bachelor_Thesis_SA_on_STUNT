...
class Diabetes(object):
    def __init__(self, tabular_size, seed, source, shot, tasks_per_batch, test_num_way, query, r1, r2):
        ...
        # Lade die Daten
        self.unlabeled_x = np.load('./data/diabetes/data/train_x.npy')  
        self.test_x = np.load('./data/diabetes/data/xtest.npy')         
        self.test_y = np.load('./data/diabetes/data/ytest.npy')         
        self.val_x = np.load('./data/diabetes/data/val_x.npy')          
        self.val_y = np.load('./data/diabetes/data/pseudo_val_y.npy')   
